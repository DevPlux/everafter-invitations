export const weddingData = {
    couple: {
        partnerOne: { firstName: "Amelia", fullName: "Amelia Rose Fernando" },
        partnerTwo: { firstName: "Noah", fullName: "Noah James Perera" },
    },
    wedding: {
    ...
    schedule: [
        {
            time: "3:30 PM",
            title: "Guest arrival",
            description: "Welcome refreshments and time to find your seat.",
        },
        {
            time: "4:00 PM",
            title: "Wedding ceremony",
            description: "Join us as we exchange our vows in the garden pavilion.",
        },
        {
            time: "5:00 PM",
            title: "Cocktails & photographs",
            description: "Raise a glass, enjoy canapés, and capture the moment with us.",
        },
        {
            time: "6:30 PM",
            title: "Dinner & celebration",
            description: "An evening of dinner, speeches, music, and dancing.",
        },
    ],
} as const;