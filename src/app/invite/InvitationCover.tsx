...
export default function InvitationCover({
  ...
  useEffect(() => {
    ...
    document.body.style.overflow = isOpen || showContent ? "" : "hidden";
  ...
  if (!isReady) {
    return <div className="fixed inset-0 bg-[#f5f1e8]" />;
  }
          ...
          >
            ...
            <div className="relative z-10 flex h-full w-full max-w-5xl flex-col items-center justify-center px-4 py-6">
              ...
              <motion.div
                ...
                animate={
                  isOpening ? { opacity: 0, y: -20 } : { opacity: 1, y: 0 }
                }
              ...
              >
                ...
                <div
                  ...
                  style={{
                    clipPath: "polygon(0 0, 52% 68%, 0 100%)",
                  }}
                />
                ...
                <div
                  ...
                  style={{
                    clipPath: "polygon(100% 0, 48% 68%, 100% 100%)",
                  }}
                />
...
function WeddingIntroduction({ guestName, token }: WeddingIntroductionProps) {
  return (
    <motion.main
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
    ...
    >
      ...
      <RsvpSection guestName={guestName} token={token} />
